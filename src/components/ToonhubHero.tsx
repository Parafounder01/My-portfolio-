...
const grainSvg = `data:image/svg+xml,%3Csvg viewBox='0 0'200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.08'/%3E%3C/svg%3E`
      ...
      <div className="relative w-full" style={{ height: '100vh', overflow: 'hidden' }}>
        ...
        >
          ...
          <div className="flex gap-3">
            ...
            >
              <ArrowLeft size={isMobile ? 22 : 26} strokeWidth={2.25} color="white" />
            </button>
            <button
            ...
            >
              <ArrowRight size={isMobile ? 22 : 26} strokeWidth={2.25} color="white" />
            </button>
          </div>
        </div>
        ...
        <a
          ...
          style={{ zIndex: 60, fontFamily: "'Anton', sans-serif" }}
        >
          <span
            style={{
